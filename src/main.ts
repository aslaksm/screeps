...
import { cullCreeps, getRoomStorage, rebalanceHarvesters } from "creeps/utils";
import { Roles } from "creeps/types";
...
export const loop = ErrorMapper.wrapLoop(() => {
  ...
  console.log("Available storage: " + getRoomStorage(Object.values(Game.rooms)[0]));
